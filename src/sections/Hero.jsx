               ...
               <div className="space-y-8">
                  ...
                  <div className="space-y-4">
                     <h1 className=" text-primary text-5xl md:text-6xl lg:text-7xl font-bold leading-tight animate-fade-in animation-delay-100">
                        ...
                        <span className="text-primary glow-text">Frontend <span className="font-serif italic font-normal text-white">
                           Web
                        </span> Developer</span>
                     ...
                     <p className="text-lg text-muted-foreground max-w-3xl animate-fade-in animation-delay-200">
                        Hi, I’m Ndumiso Mguni — a front-end developer with 5+ years of experience. I work primarily with JavaScript (ES6+), React, WordPress, AEM, and CMS platforms, creating responsive and accessible digital experiences.
                     </p>
                  </div>
                  ...
                  <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
                     ...
                     <a
                        ...
                        target="_blank"
                        className="p-2 rounded-full glass-0 text-2xl hover:bg-primary/10 hover:text-primary transition-all duration-300"
                     >
                        <FaLinkedin />
                     </a>
                     <a
